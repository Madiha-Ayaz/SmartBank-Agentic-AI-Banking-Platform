...
from backend.auth import _get_firebase_public_keys
...
from backend.routers import auth, dashboard, classify, chat, document, audit, workflows, robots, customers, smartfinance, loan, finance
...
def api_root():
    return {
        ...
        "endpoints": {
            ...
            "smartfinance_transaction_process": "POST /api/smartfinance/transaction/process",
            ...
            "loan_chat": "POST /api/loan/chat",
            "loan_accept_terms": "POST /api/loan/accept-terms",
            "loan_application": "GET /api/loan/application/{id}",
            "loan_agreement": "GET /api/loan/agreement/{id}",
            "loan_applications": "GET /api/loan/applications",
            "finance_transfer": "POST /api/finance/transfer",
            "finance_customer": "GET /api/finance/customer/{account_number}",
            "finance_search": "GET /api/finance/customer/search",
            "finance_transactions": "GET /api/finance/transactions/{account_number}",
            "finance_count": "GET /api/finance/count",
        },
    }
